...
export default function SocketHandler() {
  return null; // Placeholder to disable the component while we iterate on the WebRTC implementation
  ...
  // useEffect(() => {
  //   console.log("🟢 [LIFECYCLE] SocketHandler Mounted Socket");
  ...
  //     console.log(
  //       `🔌 [SOCKET] Notification Received Socket: ${data.type}`,
  //       data
  //     );
