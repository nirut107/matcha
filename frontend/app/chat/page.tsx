...
import { Send, MoreVertical, Phone, Video, ChevronLeft, Search, Circle } from 'lucide-react';
import Link from 'next/link';
import Header from "@/components/Header";

// Mock Matches (Section IV.6: Users who mutually liked each other)
const MOCK_MATCHES = [
        ...
        <div className="flex-grow overflow-y-auto p-6 space-y-4 bg-gray-50/30">
          {chatHistory.map((msg) => (
            <div key={msg.id} className={`flex ${msg.sender === 'me' ? 'justify-end' : 'justify-start'}`}>
              <div className={`max-w-[70%] px-4 py-3 rounded-2xl shadow-sm text-sm ${
                msg.sender === 'me'
